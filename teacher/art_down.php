...
<tr><td style="font-size:16px;"><?php echo change("任务标题1");?></td><td style="font-size:16px;"><?php echo change("任务时间1");?></td><td style="font-size:16px;" align="center"><?php echo change("课程名称");?></td><td colspan="2" style="font-size:16px;"><?php echo change("用户操作");?></td></tr>
<?php
if($result)
 {
