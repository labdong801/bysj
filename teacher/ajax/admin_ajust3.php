...
include($baseDIR."/bysj/connect_db.php");
 ...
 if($_SESSION['com_online'])
 {
 	...
 	else if($_POST['major']&&isset($_POST['teacher'])&&$_POST['year']&&$_POST['student'])
 	{
 		...
 		$sql = "UPDATE  `".$ART_TABLE."major_student_select` SET  `finally` =  '".$_POST['major']."',
		`teacher` =  '".$_POST['teacher']."' WHERE  `".$ART_TABLE."major_student_select`.`student_number` ='".$_POST['student']."';";
		mysql_query($sql);
