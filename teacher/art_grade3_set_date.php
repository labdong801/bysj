...
<?php
      ...
      if($_POST["submit"]){
         ...
         else
         {
         	...
         	$sql = "UPDATE `".$ART_TABLE."set_date` SET `student_start` = '".$student_start."',`student_end` = '".$student_end."',`teacher_start`='".$teacher_start."',`teacher_end`='".$teacher_end."'  WHERE `grade` =3;";
         	mysql_query($sql);
         }
         
      }      
      else if($_POST["clean"]){
      	$sql = "UPDATE `".$ART_TABLE."set_date` SET `student_start` = '0',`student_end` = '0',`teacher_start`='0',`teacher_end`='0'  WHERE `grade` =3;";
      	mysql_query($sql);
      }
//  
...
// 	 }
//      	 
	 $sql = "select * from ".$ART_TABLE."set_date where grade = '3'";
