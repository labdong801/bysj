...
<?php
      ...
      if($_POST["submit"]){
         ...
         else
         {
         	...
         	$sql = "UPDATE `".$ART_TABLE."set_date` SET `student_start` = '".$student_start."',`student_end` = '".$student_end."',`teacher_start`='".$teacher_start."',`teacher_end`='".$teacher_end."'  WHERE `grade` =2;";
         	mysql_query($sql);
         }
         
      }      
      else if($_POST["clean"]){
      	$sql = "UPDATE `".$ART_TABLE."set_date` SET `student_start` = '0',`student_end` = '0',`teacher_start`='0',`teacher_end`='0'  WHERE `grade` =2;";
      	mysql_query($sql);
      }
//  
...
// 	 }
//      	 
	 $sql = "select * from ".$ART_TABLE."set_date where grade = '2'";
...
<tr>
<td rowspan="2"><div align="center"><span class="STYLE1"><FONT color=red size=+2 face=黑体><B>1.</B></FONT>学生选择课题</span></div></td>
...
<tr>
<td rowspan="2"><div align="center"><span class="STYLE1"><FONT color=red size=+2 face=黑体><B>2.</B></FONT>教师选择学生</span></div></td>
<td width="100">起始时间：</td>
